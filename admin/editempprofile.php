    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">تعديل بيانات العامل</h1>

<p style="font-size:16px; color:red" align="center"> <?php if($msg){
    echo $msg;
  }  ?> </p>

<form style="margin-left: 10% ; margin-left:10%;" class="user" method="post" action="">
  <?php
$aid=$_GET['editid'];
...
<div  class="row">
                   <div class="col-6 mb-3">   <input type="text" class="form-control form-control-user" id="FirstName" name="FirstName" aria-describedby="emailHelp" value="<?php  echo $row['EmpFname'];?>"></div>
                    
                <div style="margin-top: 10px;" class="col-3 mb-4"><h5>الاسم</h5></div>
                </div> 
                ...
                <div style="margin-top: 10px;" class="col-3 mb-4"><h5>الكنية</h5></div>
                </div> 
                ...
                <div style="margin-top: 10px;" class="col-3 mb-4"><h5>الرقم الذاتي</h5></div>
                </div> 
                ...
                <div style="margin-top: 10px;" class="col-3 mb-4"><h5>القسم</h5></div>
                </div> 
                ...
                <div style="margin-top: 10px;" class="col-3 mb-4"><h5>الاختصاص</h5></div>
                </div> 
                ...
                <div style="margin-top: 10px;" class="col-3 mb-4"><h5>رقم الجوال</h5></div>
                </div> 
                ...
                <div style="margin-top: 10px;" class="col-3 mb-4"><h5>البريد الالكتروني</h5></div>
                </div> 
                ...
                <div class="row">
                    ...
                    <div style="margin-top: 10px;" class="col-3 mb-1"><h5>(yyyy-mm-dd) تاريخ التسجيل</h5></div>
                    </div>
...
{?>
 ...
 <span style="margin-top: 10px; margin-right: 10px;" class="col-3 mb-4"></span>

  <input type="radio" name="gender" value="Female" checked="true">Female
                   <?php }?>
                  </div>
                    
                <div style="margin-top: 10px;" class="col-3 mb-4"><h5>الجنس</h5></div>
                </div> 
